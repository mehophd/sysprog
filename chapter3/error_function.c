...
static void terminate(Boolean useExit3) {
    char *s;
    /*
    Сохраняет дамп ядра, если переменная среды EF_DUMPCORE определена и содержит непустую строку
    в противном случае вызывает exit(3) или _exit(2)
    в зависимости от значения useExit(3)
    */
